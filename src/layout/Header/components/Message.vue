		...
		<el-popover placement="bottom" :width="300" trigger="click">
			<template #reference>
				<el-badge :value="5" class="item">
					<el-tooltip effect="dark" content="消息通知" placement="bottom" :show-after="200">
						<i :class="'iconfont icon-xiaoxi'" class="icon-style"></i>
					</el-tooltip>
				</el-badge>
			</template>
					...
					<div class="message-list">
						<div class="message-item">
							...
							<div class="message-content">
								<span class="message-title">请给 Geeker-Admin 一键三连 🧡</span>
